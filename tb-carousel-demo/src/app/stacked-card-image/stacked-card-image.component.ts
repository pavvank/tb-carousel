...
@Component({
  selector: 'app-stacked-card-image',
  templateUrl: './stacked-card-image.component.html',
  styleUrls: ['./stacked-card-image.component.css']
})
export class StackedCardImageComponent implements OnInit {
