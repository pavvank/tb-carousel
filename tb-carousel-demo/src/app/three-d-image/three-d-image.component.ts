...
@Component({
  selector: 'app-three-d-image',
  templateUrl: './three-d-image.component.html',
  styleUrls: ['./three-d-image.component.css']
})
export class ThreeDImageComponent implements OnInit {
